<script lang="ts">
  import { Card, Button, Heading, Breadcrumb, BreadcrumbItem, P, Span, List, Li } from "flowbite-svelte";
    ...
    <div class="flex space-x-3">
      <div class="flex-1">
        ...
        <List tag="ul" class="space-y-1">
          ...
          <Li>
            <Link href="https://learn.microsoft.com/en-us/aspnet/core/signalr">SignalR</Link>
          </Li>
          <Li>
